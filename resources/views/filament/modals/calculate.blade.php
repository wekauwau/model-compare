...
@else
    @php
        ...
        $r2_rf_right = collect($cars)->map(function ($car) use ($mean_actual) {
            ...
            return [
                'expression' =>
                    '(' . number_format($actual, 2) . ' - ' . number_format($mean_actual, 2) . ')<sup>2</sup>',
    ...
    <div>
        ...
        <x-filament.modals.calculate.card :$n :mae_step_1="$mae_xgb_step_1" :mae_step_2="$mae_xgb_step_2" :mae="$mae_xgb"
            :mape_step_1="$mape_xgb_step_1" :mape_step_2="$mape_xgb_step_2" :mape_step_3="$mape_xgb_step_3" :mape="$mape_xgb" :r2_left_step_1="$r2_xgb_left_step_1"
            :r2_left_step_2="$r2_xgb_left_step_2" :r2_left_step_3="$r2_xgb_left_step_3" :r2_left_step_4="$r2_xgb_left_step_4" :r2_right_step_1="$r2_xgb_right_step_1" :r2_right_step_2="$r2_xgb_right_step_2"
            :r2_right_step_3="$r2_xgb_right_step_3" :r2_right_step_4="$r2_xgb_right_step_4" :r2_left_right="$r2_xgb_left_right" :r2="$r2_xgb"
            class="bg-green-50 border-green-600">
            <x-slot:heading class="text-green-600">
                XGBoost
            </x-slot>
        </x-filament.modals.calculate.card>

        <x-filament.modals.calculate.card :$n :mae_step_1="$mae_lgbm_step_1" :mae_step_2="$mae_lgbm_step_2" :mae="$mae_lgbm"
            :mape_step_1="$mape_lgbm_step_1" :mape_step_2="$mape_lgbm_step_2" :mape_step_3="$mape_lgbm_step_3" :mape="$mape_lgbm" :r2_left_step_1="$r2_lgbm_left_step_1"
            :r2_left_step_2="$r2_lgbm_left_step_2" :r2_left_step_3="$r2_lgbm_left_step_3" :r2_left_step_4="$r2_lgbm_left_step_4" :r2_right_step_1="$r2_lgbm_right_step_1" :r2_right_step_2="$r2_lgbm_right_step_2"
            :r2_right_step_3="$r2_lgbm_right_step_3" :r2_right_step_4="$r2_lgbm_right_step_4" :r2_left_right="$r2_lgbm_left_right" :r2="$r2_lgbm"
            class="bg-yellow-50 border-yellow-600">
